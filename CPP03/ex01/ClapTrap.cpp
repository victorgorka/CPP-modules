...
/*   Updated: 2023/08/02 19:13:32 by vde-prad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	std::cout << "\e[0;31mClapTrap constructor called\e[0m\n";
}

ClapTrap::ClapTrap(std::string name)
{
	std::cout << "\e[0;31mClapTrap\e[0m "<< name << " \e[0;31mconstructor called\e[0m\n";
	_name = name;
	_hitP = 10;
	_energyP = 10;
	_attackD = 0;
...
void	ClapTrap::attack(const std::string &target)
{
	...
	{
		std::cout << this->_name << " attacks " << target << ", causing "<< this->_attackD << " points of damage!\n";
		this->_energyP--;
	}
}
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		this->_hitP -= amount;
		std::cout << this->_name << " takes " << amount << " damage points!\n";
	}
}
